...
<head>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.showLoad();
            $.ajaxPost("${path}/publish/activityPerson_addSave.do", {"activityPerson":activityPerson}, function(result) {
                if(result=="1"){
    ...
    <form id="form" name="form" style="+zoom:1;">
        <table class="table-border" width="100%">
            ...
            <tr>
                <td class="th">人物ID</td>
                <td class="td">
                	<input type="text" id="person_id" name="person_id" class="input easyui-numberbox" min="0" max="9999999999" precision="0" style="display:none"/>
                	<input type="text" id="person_name" name="person_name" class="input" disabled="true" style="width:300px;"/>
            ...
            <tr>
                <td class="th">活动ID</td>
                <td class="td">
                	<input type="text" id="activity_id" name="activity_id" class="input easyui-numberbox" min="0" max="9999999999" precision="0" style="display:none"/>
                	<input type="text" id="activity_name" name="activity_name" class="input" disabled="true" style="width:300px;"/>
