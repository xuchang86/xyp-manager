...
<div region="center" border="false" style="padding:10px;">
    <form id="form" name="form" style="+zoom:1;">
        <table class="table-border" width="100%">
            ...
            <tr>
                <td class="th">性别</td>
                <td class="td"><input type="text" id="sex" name="sex" class="input easyui-numberbox" min="0" max="9999999999" precision="0" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">用户名</td>
            ...
            <tr>
                ...
                <td class="td"><input type="text" id="ispay" name="ispay" class="input easyui-numberbox" min="0" max="9999999999" precision="0" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">个人头像</td>
