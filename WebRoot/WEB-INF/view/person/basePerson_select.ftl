...
//                            </#if>
                ...
                columns:[[
                    {title:'用户id',field:'user_id',width:150,sortable:true,hidden:true},
                    {title:'级别',field:'level',width:150,sortable:true,hidden:true},
                    {title:'逍遥币',field:'bill',width:150,sortable:true,hidden:true},
                    {title:'师傅id',field:'parent_id',width:150,sortable:true,hidden:true},
        ...
        function select(){
        	...
        	if(selections==null || selections.length==0){
        		$.messager.alert("系统提示","请选择人物","info");
        		return;
        	}
