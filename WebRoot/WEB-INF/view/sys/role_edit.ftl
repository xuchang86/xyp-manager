...
<head>
    ...
    <script type="text/javascript">
        ...
        function editSave(){
            ...
            $.ajaxPost("${path}/sys/role_editSave.do",{"role":role, "menuAction":menuAction}, function(response){
...
<form id="form" name="form" style="width: 100%;height: 100%">
<input id="sr_id" name="sr_id" type="hidden" value="${role.sr_id}"/>
<input id="sr_status" name="sr_status" type="hidden" value="${role.sr_status}"/>
<table cellpadding="4">
    <tr>
        <td>角色编码:</td>
        <td><input id="sr_code" name="sr_code" type="text" class="input easyui-validatebox" validType="maxLength[30]" required="true" value="${role.sr_code}"/></td>
        <td>角色名称:</td>
        <td><input id="sr_name" name="sr_name" type="text" class="input easyui-validatebox" validType="maxLength[30]" required="true" value="${role.sr_name}"/></td>
        <td><a href="javascript:editSave();" class="easyui-linkbutton" icon="icon-ok">保存</a></td>
