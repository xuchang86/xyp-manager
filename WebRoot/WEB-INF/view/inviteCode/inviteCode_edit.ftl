...
<div region="center" border="false" style="padding:10px;">
    <form id="form" name="form" style="+zoom:1;">
        ...
        <table class="table-border" width="100%">
            ...
            <tr>
                <td class="th">用户ID</td>
                <td class="td"><input type="text" id="user_id" name="user_id" class="input easyui-numberbox" min="0" max="9999999999" precision="0" value="${(inviteCode.user_id)!}" style="width:300px;"/></td>
            </tr>
            <tr>
