...
<head>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.showLoad();
            $.ajaxPost("${path}/goods/goodsComment_editSave.do", {"goodsComment":goodsComment}, function(result) {
                if(result=="1"){
    ...
    <form id="form" name="form" style="+zoom:1;">
        ...
        <table class="table-border" width="100%">
            ...
            <tr>
                <td class="th">评论人</td>
                <td class="td">
	                <input type="text" id="user_name" name="user_name" class="input easyui-validatebox" value="${(goodsComment.user_name)!}" validType="maxLength[100]" style="width:300px;"/>
	            	<input type="button" onclick="selectProject('选择评论人','${path}/login/loginUser_select.do?callback=selectUser')" value="选择评论人">
	            	<input type="text" id="user_id" name="user_id" style="width:300px;visibility:hidden;" value="${(goodsComment.user_id)!}"/>
                </td>
            </tr>
            <tr>
                <td class="th">评论时间</td>
                <td class="td"><input type="text" id="create_date" name="create_date" class="input Wdate" onclick="WdatePicker()" value="<@dateOut goodsComment.create_date/>" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">评论内容</td>
                <td class="td"><input type="text" id="content" name="content" class="input easyui-validatebox" validType="maxLength[500]" value="${(goodsComment.content)!}" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">商品</td>
                <td class="td">
	                <input type="text" id="goods_name" name="goods_name" class="input easyui-validatebox" value="${(goodsComment.goods_name)!}" validType="maxLength[100]" style="width:300px;"/>
	            	<input type="button" onclick="selectProject('选择商品','${path}/goods/mallGoods_select.do?callback=selectGoods')" value="选择商品">
	            	<input type="text" id="goods_id" name="goods_id" style="width:300px;visibility:hidden;" value="${(goodsComment.goods_id)!}" />
                </td>
            </tr>
            <tr>
                <td class="th">订单</td>
                <td class="td">
	                <input type="text" id="order_name" name="order_name" class="input easyui-validatebox" value="${(goodsComment.order_name)!}" validType="maxLength[100]" style="width:300px;"/>
