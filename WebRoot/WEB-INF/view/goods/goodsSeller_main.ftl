    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $("#table").datagrid({
                ...
                columns:[[
                    {title:'昵称',field:'nick_name',width:150,sortable:true},
                    {title:'真实姓名',field:'real_name',width:150,sortable:true},
                    ...
                    {title:'账户',field:'account',width:150,sortable:true}
                ]],
                toolbar:[
                    {
                        handler:refreshPage,
        ...
        function gridRowClick(index, rowData) {
            if (from) {
                window.opener.sellerCallBack(rowData);
                window.close();
            }
        }
        ...
        function add() {
            ...
            $("#iframe").attr("src", "${path}/goods/goodsSeller_add.do");
        }
        ...
        function edit(event, value) {
            ...
            $("#iframe").attr("src","${path}/goods/goodsSeller_edit.do?id="+value);
        }
        ...
        function del(event,val) {
            ...
            $.messager.confirm("提示信息", "你确认要删除该记录吗？", function(b) {
                if (b) {
                    $.ajaxPost("${path}/goods/goodsSeller_delete.do",{"id":val},function(result){
                        $.messager.show({
                            title:"消息提醒",
                            msg:"记录删除成功",
                            timeout:5000,
            ...
            if(selections.length==0){
                ...
                $.messager.confirm("系统提示", "你确认要删除所选择的记录吗？", function(b){
                    if(b){
                        ...
                        $.ajaxPost("${path}/goods/goodsSeller_deleteBatch.do", {"ids":ids}, function(result) {
                            $.messager.show({
                                title:"消息提醒",
                                msg:"记录删除成功",
                                timeout:5000,
        ...
        function view(event,value){
            ...
            $("#iframe").attr("src","${path}/goods/goodsSeller_view.do?id="+value);
        }
        ...
        function refreshPage(){
            window.location="${path}/goods/goodsSeller_main.do";
            return false;
        }
        ...
        function searchPage(reset) {
            ...
            goodsSeller.refresh = "1"; //刷新记录数参数
            $("#table").datagrid("clearSelections").datagrid("load",goodsSeller);
        }
    </script>
</head>
...
<div region="west" split="true" border="true" title="操作面板" style="width:250px;padding:10px;">
    <form id="form" name="form" style="display: none">
        <table class="table">
            <tr>
                <td class="th">昵称</td>
                <td class="td"><input id="nick_name" name="nick_name" type="text" class="input"></td>
            </tr>
            <tr>
                <td class="th">真实姓名</td>
                <td class="td"><input id="real_name" name="real_name" type="text" class="input"></td>
            </tr>
            <tr>
                <td class="th">城市</td>
            ...
            <tr>
                <td class="th">邮箱</td>
                <td class="td"><input id="email" name="email" type="text" class="input"></td>
            </tr>
            <tr>
                <td class="th">账户</td>
...
<div region="center" title="当前位置：卖家信息管理">
    <table id="table"
           url="${path}/goods/goodsSeller_page.do"
           border="false"         <#--无边框-->
           fit="true"             <#--自动填充宽度高度-->
