...
<div region="center" border="false" style="padding:10px;">
    <form id="form" name="form" style="+zoom:1;">
        ...
        <table class="table-border" width="100%">
            ...
            <tr>
                <td class="th">运费</td>
                <td class="td"><input type="text" id="freight" name="freight" class="input easyui-numberbox" min="0" max="99999999.99" precision="2" value="${(mallGoods.freight)!}" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">创建用户</td>
                <td class="td">
