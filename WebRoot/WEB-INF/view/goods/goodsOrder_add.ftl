...
<head>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.showLoad();
            $.ajaxPost("${path}/goods/goodsOrder_addSave.do", {"goodsOrder":goodsOrder}, function(result) {
                if(result=="1"){
    ...
    <form id="form" name="form" style="+zoom:1;">
        <table class="table-border" width="100%">
            ...
            <tr>
                ...
                <td class="td"><input type="text" id="goods_id" name="goods_id" class="input easyui-validatebox" validType="maxLength[20]" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">收货地址</td>
            ...
            <tr>
                <td class="th">联系人</td>
                <td class="td"><input type="text" id="contacts" name="contacts" class="input easyui-validatebox" validType="maxLength[10]" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">联系电话</td>
            ...
            <tr>
                <td class="th">订单状态</td>
                <td class="td"><input type="text" id="state" name="state" class="input easyui-validatebox" validType="maxLength[20]" style="width:300px;"/></td>
            </tr>
        </table>
    </form>
</div>
