...
<div region="center" border="false" style="padding:10px;">
    <form id="form" name="form" style="+zoom:1;">
        <table class="table-border" width="100%">
            ...
            <tr>
                <td class="th">商品描述</td>
                <td class="td"><input type="text" id="description" name="description" class="input easyui-validatebox" validType="maxLength[150]" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">商品编码</td>
            ...
            <tr>
                ...
                <td class="td"><input type="text" id="type_id" name="type_id" class="input easyui-numberbox" min="0" max="9999999999" precision="0" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">商品价格</td>
            ...
            <tr>
                <td class="th">是否出售</td>
                <td class="td"><input type="text" id="is_sale" name="is_sale" class="input easyui-numberbox" min="0" max="999" precision="0" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">卖家id</td>
                <td class="td"><input type="text" id="seller_id" name="seller_id" class="input easyui-numberbox" min="0" max="9999999999" precision="0" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">会员价格</td>
